...
//    }
    ...
    //<div class="ingredienttime" style="position:absolute; font-size:10px; color:green; right:10px; bottom:-15px;">${ingredientdetail.ingredientTime.slice(-8)}</div>
